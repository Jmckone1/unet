...
from Unet_modules.Full_model_dataloader_test import BraTs_Dataset
            ...
            if save == True:
                for i in range(cur_batch_size):
                    ...
                    if img_num == 155:
                        ...
                        nib.save(pred_img_save, os.path.join('Predictions/Full_model_predictions_2' + ext + "_" + d[data_val] + '_' + str(int(mean_val*100)) + "_" + save_val +'.nii.gz'))  
...
checkpoint = torch.load("Checkpoints/Full_model_MK1_H16_O4A4_Unfrozen/checkpoint_2.pth")
...
#                         pred_img_save = nib.Nifti1Image(pred_img, np.eye(4))
#                         nib.save(pred_img_save, os.path.join('Predictions/Full_model_predictions' + ext + "_" + str(data_val) + '_' + str(int(mean_val*100)) + "_" + save_val +'.nii.gz'))  
...
# checkpoint = torch.load("Checkpoints/Full_model_MK1_H16_O4A4/checkpoint_2.pth")
...
# dataset_single = BraTs_Dataset("Brats_2018_data_split/Validation", path_ext = ["/HGG","/LGG"],size=size, apply_transform=False)
# Single_data = DataLoader(
#     dataset=dataset_single,
#     batch_size=batch_size,
#     shuffle=False)

# Test_save(Single_data, unet, unet_opt, path_ext = ["/HGG","/LGG"], save=True)