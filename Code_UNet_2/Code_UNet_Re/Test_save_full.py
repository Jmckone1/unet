...
def Test_save(Test_data, mask_names, unet, unet_opt, path, path_ext, save_path, load_path, save=False, save_image = False, save_val =""):
...
#                 input("")
                ...
                mask_path = os.getcwd() + "/Brats_2018_4/labelsTr/" + mask_names[data_val] + ".nii.gz"
...
#                         mask_all[:,:,i] = mask
                    ...
                    print("Concat: ", dataloader_path[i][27:])
...
#                         input("Waiting for input")
                        ...
                        print("Path to save to", save_path + dataloader_path[i][27:])
#                         input("checking")
                        
                        nib.save(pred_img_save, os.path.join(save_path + dataloader_path[i][27:])) 
