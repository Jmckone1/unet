...
class Load_Dataset(Dataset):
    ...
    def __getitem__(self,idx):
        ...
        if Param.Parameters.Network["Hyperparameters"]["Apply_Augmentation"] == True:
    ...
    def augmentation(self, img, label):
        ...
        min_max = [int(Param.Parameters.Network["Hyperparameters"]["Image_size"][0] - 
                       int(Param.Parameters.Network["Hyperparameters"]["Image_size"][0]/ 6)),
                   int(Param.Parameters.Network["Hyperparameters"]["Image_size"][1] - 
                       int(Param.Parameters.Network["Hyperparameters"]["Image_size"][1] / 6))]

        if Param.Parameters.Network["Global"]["Debug"] : print("Augmentation")
        ...
        if Param.Parameters.Network["Hyperparameters"]["Regress"] == True:
            ...
            transform1 = A.Compose([
                ...
                A.RandomSizedCrop(min_max,
                                  width = Param.Parameters.Network["Hyperparameters"]["Image_size"][0],
                                  height = Param.Parameters.Network["Hyperparameters"]["Image_size"][1],
            ...
            if Param.Parameters.Network["Hyperparameters"]["Input_dim"] > 1:
                img = np.reshape(img,(Param.Parameters.Network["Hyperparameters"]["Image_size"][0],
                                      Param.Parameters.Network["Hyperparameters"]["Image_size"][1],
                                      Param.Parameters.Network["Hyperparameters"]["Input_dim"]))
            
                transformed = transform1(image=img[..., :Param.Parameters.Network["Hyperparameters"]["Input_dim"]], keypoints=keypoint_format)
                
                img = np.reshape(img,(Param.Parameters.Network["Hyperparameters"]["Input_dim"],
                                      Param.Parameters.Network["Hyperparameters"]["Image_size"][0],
                                      Param.Parameters.Network["Hyperparameters"]["Image_size"][1]))
            else:
                if img.ndim == 3:
        ...
        if Param.Parameters.Network["Hyperparameters"]["Regress"] == False:
            ...
            if Param.Parameters.Network["Hyperparameters"]["Input_dim"] > 1:
                ...
                transformed_img = transformed['image']
                transformed_img = np.reshape(transformed_img,(Param.Parameters.Network["Hyperparameters"]["Input_dim"],
                                      Param.Parameters.Network["Hyperparameters"]["Image_size"][0],
                                      Param.Parameters.Network["Hyperparameters"]["Image_size"][1]))
